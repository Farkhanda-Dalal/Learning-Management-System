...
<c:set var="b" value="${sessionScope.message}"/>
<c:if test="${b != null && !b}">
<div class="mx-auto p-3" style="width: 500px">
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      <i class="fa-sharp fa-solid fa-circle-exclamation" style="color: #000000;"></i>
     	Invalid OTP. Enter email to resend OTP
    </div>
  </div>
</c:if>
			...
			<div class="col-lg-8 col-md-10">
				...
				<form class="card mt-4" action="ForgotPasswordController" method="POST">
					...
					<div class="card-footer">
						...
						<button class="btn btn-danger" type="submit"> <a href="Login.jsp" style="color: white;text-decoration: none;">
