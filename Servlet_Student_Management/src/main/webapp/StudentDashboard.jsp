...
<body>
	<nav class="navbar navbar-expand-lg">
		<div>
			...
			<h3 style="margin-left: 15px">Welcome ${name}</h3>
		</div>
	...
	<c:if test="${iobj !=null && iobj==0}">
		<div class="mx-auto" style="width: 500px">
			<div class="alert alert-warning alert-dismissible fade show"
				...
				<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Invalid
				Class Name or Id!
			</div>
		</div>
	</c:if>
	...
	<c:set var="eobj" value="${sessionScope.enrolled}"></c:set>
	<c:if test="${eobj !=null && eobj==1}">
		<div class="mx-auto" style="width: 500px">
			<div class="alert alert-warning alert-dismissible fade show"
				role="alert">
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
				<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Your
				were enrolled in the class!
			</div>
		</div>
	</c:if>
	<c:remove var="enrolled" scope="session" />
	...
	<c:if test="${bool != null && !bool}">
		<div class="mx-auto p-3" style="width: 500px">
			<div class="alert alert-warning alert-dismissible fade show"
				...
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
				<i class="fa fa-exclamation-circle" aria-hidden="true"></i> Name
				doesn't match the given Roll No!
			</div>
		</div>
	</c:if>
	<c:remove var="result" scope="session" />

	<c:set var="bool1" value="${sessionScope.roll}" />
	<c:if test="${bool1 != null && !bool1}">
		<div class="mx-auto p-3" style="width: 500px">
			<div class="alert alert-warning alert-dismissible fade show"
				role="alert">
				<button type="button" class="btn-close" data-bs-dismiss="alert"
	...
	<div class="row todocards gx-5">
					...
					<form action="StudentDashboardController">
						<div class="mb-3">
							<label style="padding-top: 10px">Class Name</label> <input
								...
								style="padding-top: 10px">Name</label> <input type="text"
								class="form-control" name="s_name"> <label
								style="padding-top: 10px">RollNo</label> <input type="number"
								class="form-control" name="rollNo"><br>
							<button type="submit" class="btn btn-success" name="join_class">Join</button>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="col-sm-3">
			<div class="card">
				<div class="card-body">
					<h4>Leave A Class</h4>
					<form action="StudentDashboardController" method="post">
						<label style="padding-top: 10px">Class Name</label> <input
							type="text" class="form-control" name="c_name"> <label
							style="padding-top: 10px">Class Id</label> <input type="text"
							class="form-control" name="c_id"><label
							style="padding-top: 10px">Roll Number</label> <input
							type="number" class="form-control" name="rollNo"> <label
							style="padding-top: 10px">Password</label> <input type="password"
							class="form-control" name="pass"><br>
						<button type="submit" class="btn btn-success" name="leave_class"
							style="margin-bottom: 20px">Leave</button>
					</form>
				</div>
			</div>
		</div>
	...
	<a href="StudentDashboardController?slider=false">
		<div class="card mx-5 mb-5"
			style="height: 100px; width: 100px; float: left; margin-top: 30px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
			<div class="card-body">
				<h5 class="text-center" style="color: black; margin: 0;">View
					Joint Classes</h5>
			</div>
		</div>
	</a>
	...
	<c:if test="${not empty classList}">
		<div class="card"
			style="height: 100px; width: 550px; margin-top: 30px;">
			<div class="card-body text-center">
				<c:forEach items="${classList}" var="className">
					<a href="StudentClass.jsp?className=${className}"
						style="font-size: 20px; text-decoration: none; color: black; padding: 20px;">${className}</a>
				</c:forEach>
			</div>
		</div>
	</c:if>
